...
//	html += "	<div class='gutter'></div>";
	...
	html += "				<tr class='table-head'><th class='id sort-th'>Id</th><th class='firstname sort-th'>"+karutaStr[LANG]['firstname']+"</th><th class='lastname  sort-th'>"+karutaStr[LANG]['lastname']+"</th><th class='c-a-s sort-th'>"+karutaStr[LANG]['c-a-s']+"</th><th class='username sort-th'>"+karutaStr[LANG]['username']+"</th><th class='buttons'></th></tr>";
