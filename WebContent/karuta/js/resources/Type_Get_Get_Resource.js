...
//			portfoliocode = cleanCode(portfoliocode); // portfoliocode may be from a get_ressource with spécial characters
			...
			} else if (query.indexOf('parent.parent.parent.parent.parent.parent.parent.parentcode')>-1) {
				code_parent = $($("code",$(this.node).parent().parent().parent().parent().parent().parent().parent().parent()[0])[0]).text();
				value_parent = $($("value",$(this.node).parent().parent().parent().parent().parent().parent().parent().parent()[0])[0]).text();
			} else if (query.indexOf('parent.parent.parent.parent.parent.parent.parentcode')>-1) {
				code_parent = $($("code",$(this.node).parent().parent().parent().parent().parent().parent().parent()[0])[0]).text();
				value_parent = $($("value",$(this.node).parent().parent().parent().parent().parent().parent().parent()[0])[0]).text();
