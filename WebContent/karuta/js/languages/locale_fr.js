...
karutaStr['fr']['tipnewpassword']="Si vous ne trouvez pas le message dans votre boîte de réception, vérifiez dans votre dossier «&nbsp;courrier indésirable&nbsp;» ou «&nbsp;spam&nbsp;»";
...
karutaStr['fr']['password-sent']="Un nouveau mot de passe a été envoyé par courriel. Si vous ne trouvez pas le message dans votre boîte de réception, vérifiez votre dossier « courrier indésirable » ou « spam »";
...
karutaStr['fr']['queryasmUnitStructure']=karutaStr['fr']['queryGet_Resource'];
karutaStr['fr']['queryasmUnit']=karutaStr['fr']['queryGet_Resource'];
karutaStr['fr']['queryasmStructure']=karutaStr['fr']['queryGet_Resource'];
...
karutaStr['fr']['queryURL2UnitBlock']=karutaStr['fr']['queryURL2Unit'];
karutaStr['fr']['queryURL2Portfolio']="Recherche <br/><span style='font-size:smaller'> partie du code_portfolio.<i>label</i>";
karutaStr['fr']['queryURL2PortfolioBlock']=karutaStr['fr']['queryURL2Portfolio'];
karutaStr['fr']['queryGet_Get_Resource']="Recherche <br/><span style='font-size:smaller'> code_portfolio.<i>child</i>|<i>parent</i>[.<i>parent</i>].tag_sémantique1.tag_sémantique2.<i>label</i><br> Mot réservé pour code_portfolio : <i>self</i></span>";
...
karutaStr['fr']['graphicerroles']="Graphiqueur";
...
karutaStr['fr']['moveinroles']="Déplacer";
...
karutaStr['fr']['incrementroles']="Incrémenter seulement";
karutaStr['fr']['hide-button']="Cacher édition";
karutaStr['fr']['show-button']="Montrer édition";
karutaStr['fr']['share']="Partage";
karutaStr['fr']['sharetoroles']="Partager";
karutaStr['fr']['sharetoemail']="Partager avec";
...
karutaStr['fr']['sharewithrole']="Destinataire";
karutaStr['fr']['maxchar']="Min Caractères";
karutaStr['fr']['maxword']="Max Mots";
...
karutaStr['fr']['seeqrcoderoles']="Voir QR Code et URL";
...
karutaStr['fr']['printroles']="Imprimer";
...
karutaStr['fr']['seecalendarroles']="Voir - Calendrier";
...
karutaStr['fr']['export-project']="Exporter le dossier";
karutaStr['fr']['archive-project']="Archiver le dossier";
...
karutaStr['fr']['getRTF']="Créer RTF";
karutaStr['fr']['getWebsite']="Exporter site Web";
...
karutaStr['fr']['create_project']="Créer un dossier";
...
karutaStr['fr']['batch-wait']="<div class='danger'>NE PAS FERMER CETTE PAGE.<BR/> MÊME SI UN POP-UP VOUS PROPOSE DE FERMER LA PAGE, IL FAUT ATTENDRE. <BR/> La fin de l'exécution du batch est indiquée par THIS IS THE END.</div>";
//=========================================
//========== REPORT ========================
//=========================================
...
karutaStr['fr']['URL2Portfolio']="URL2Portfolio";
...
karutaStr['fr']['URL2PortfolioBlock']="URL2PortfolioBlock";
karutaStr['fr']['TextFieldBlock']="TextFieldBlock";
karutaStr['fr']['BubbleMap']="BubbleMap";
