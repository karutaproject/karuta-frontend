...
<xsl:stylesheet version="1.0"
	...
	<!-- ================ user-attribute ============================ -->
	<xsl:template match="*[metadata/@semantictag='user_attribute']">
		...
		<user-attribute>
			<xsl:attribute name="select"><xsl:value-of select="$todisplay"/></xsl:attribute>
		</user-attribute>
	</xsl:template>
	<!-- ================ userid ============================ -->
	...
	<xsl:template match="*[metadata/@semantictag='url2portfolio']">
		...
		<url2portfolio>
			<xsl:attribute name="user-role"><xsl:value-of select="$userrole"/></xsl:attribute>
			<xsl:if test="not($class='')">
				<xsl:attribute name="class"><xsl:value-of select="$class"/></xsl:attribute>
			</xsl:if>
	...
	<!-- ================ for-each-usergroup ============================ -->
	<xsl:template match="*[metadata/@semantictag='for-each-usergroup']">
		<xsl:variable name="ref-init">
			<xsl:value-of select="asmContext[metadata/@semantictag='ref-init']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="countvar">
		...
		<xsl:variable name="select">
 		...
 		<for-each-usergroup select='{$select}'>
			<xsl:if test="not($ref-init='')">
				<xsl:attribute name="ref-init"><xsl:value-of select="$ref-init"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($countvar='')">
	...
	<xsl:template match="*[metadata/@semantictag='for-each-portfoliogroup']">
		<xsl:variable name="ref-init">
			<xsl:value-of select="asmContext[metadata/@semantictag='ref-init']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="countvar">
		...
		<xsl:variable name="select">
 		...
 		<for-each-portfoliogroup select='{$select}'>
			<xsl:if test="not($ref-init='')">
				<xsl:attribute name="ref-init"><xsl:value-of select="$ref-init"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($countvar='')">
	...
	<!-- ================ for-each-node-js ============================ -->
	<xsl:template match="*[metadata/@semantictag='for-each-node-js']">
		<xsl:variable name="ref-init">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='ref-init']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="countvar">
		...
		<for-each-node-js select='{$select}'>
			<xsl:if test="not($ref-init='')">
				<xsl:attribute name="ref-init"><xsl:value-of select="$ref-init"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($countvar='')">
	...
	<xsl:template match="*[metadata/@semantictag='for-each-node']">
		...
		<xsl:variable name="portfolio">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='portfolio']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="nodetype">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='nodetype']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		...
		<for-each-node>
			...
			<xsl:if test="not($portfolio='')">
				<xsl:attribute name="portfolio"><xsl:value-of select="$portfolio"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($countvar='')">
				<xsl:attribute name="countvar"><xsl:value-of select="$countvar"/></xsl:attribute>
			</xsl:if>
	...
	<xsl:template match="*[metadata/@semantictag='draw-xy-axis']">
		...
		<xsl:variable name="x-displaygraduation">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='x-displaygraduation']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		...
		<xsl:variable name="y-displaygraduation">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='y-displaygraduation']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		...
		<draw-xy-axis>
			...
			<xsl:attribute name="x-displaygraduation"><xsl:value-of select="$x-displaygraduation"/></xsl:attribute>
			...
			<xsl:attribute name="y-displaygraduation"><xsl:value-of select="$y-displaygraduation"/></xsl:attribute>
	...
	<xsl:template match="*[metadata/@semantictag='draw-data']">
		<xsl:variable name="graphtype">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='graphtype']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="point-variable">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='point-variable']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="point-nodetype">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='point-nodetype']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="point-semtag">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='point-semtag']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="point-todisplay">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='point-todisplay']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="legend-variable">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='legend-variable']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		...
		<xsl:variable name="xgrad-variable">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='xgrad-variable']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="ygrad-variable">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='ygrad-variable']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="xgrad-nodetype">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='xgrad-nodetype']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="ygrad-nodetype">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='ygrad-nodetype']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="xgrad-semtag">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='xgrad-semtag']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="xgrad-todisplay">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='xgrad-todisplay']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="ygrad-semtag">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='ygrad-semtag']/asmResource[@xsi_type='Field']/text[@lang=$lang]"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="ygrad-todisplay">
			<xsl:value-of select=".//asmContext[metadata/@semantictag='ygrad-todisplay']/asmResource[@xsi_type='Get_Resource']/value"></xsl:value-of>
		</xsl:variable>
		<xsl:variable name="ref">
		...
		<xsl:variable name="point-select"><xsl:value-of select="$point-nodetype"/>.<xsl:value-of select="$point-semtag"/>.<xsl:value-of select="$point-todisplay"/></xsl:variable>
		...
		<xsl:variable name="xgrad-select"><xsl:value-of select="$xgrad-nodetype"/>.<xsl:value-of select="$xgrad-semtag"/>.<xsl:value-of select="$xgrad-todisplay"/></xsl:variable>
		<xsl:variable name="ygrad-select"><xsl:value-of select="$ygrad-nodetype"/>.<xsl:value-of select="$ygrad-semtag"/>.<xsl:value-of select="$ygrad-todisplay"/></xsl:variable>
		<draw-data>
			<xsl:attribute name="ref"><xsl:value-of select="$ref"/></xsl:attribute>
			<xsl:attribute name="graphtype"><xsl:value-of select="$graphtype"/></xsl:attribute>
			<xsl:attribute name="point-variable"><xsl:value-of select="$point-variable"/></xsl:attribute>
			<xsl:attribute name="xgrad-variable"><xsl:value-of select="$xgrad-variable"/></xsl:attribute>
			<xsl:attribute name="ygrad-variable"><xsl:value-of select="$ygrad-variable"/></xsl:attribute>
			<xsl:attribute name="legend-variable"><xsl:value-of select="$legend-variable"/></xsl:attribute>
			<xsl:if test="not($point-select='..')">
				<xsl:attribute name="point-select"><xsl:value-of select="$point-select"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($legend-select='..')">
				<xsl:attribute name="legend-select"><xsl:value-of select="$legend-select"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($xgrad-select='..')">
				<xsl:attribute name="xgrad-select"><xsl:value-of select="$xgrad-select"/></xsl:attribute>
			</xsl:if>
			<xsl:if test="not($ygrad-select='..')">
				<xsl:attribute name="ygrad-select"><xsl:value-of select="$ygrad-select"/></xsl:attribute>
			</xsl:if>
		</draw-data>
	</xsl:template>
